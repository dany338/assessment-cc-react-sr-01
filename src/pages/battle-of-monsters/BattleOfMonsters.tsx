...
import { Winner, WinnerInvalid } from "../../models/interfaces/monster.interface"
...
const BattleOfMonsters = () => {
    ...
    const [ winner, setWinner ] = useState<Winner | WinnerInvalid | any>(null)
    ...
    return (
        <PageContainer>
            ...
            <BattleSection>
                ...
                <MonsterBattleCard monster={selectedMonsterComputer} title={selectedMonsterComputer?.name || "Player"}></MonsterBattleCard>
            </BattleSection>
        </PageContainer>
    )
}
